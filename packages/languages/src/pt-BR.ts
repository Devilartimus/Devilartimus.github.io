export default {
  editor: {
    new: {
      ...
      description3:
        'предлагает стили дизайна, чтобы вы могли адаптироваться к своим потребностям.',
      blank: {
        title: 'Пустой',
        description:
          'Стандартный редактор. Рекомендуется для простых проектов, не требующих специальных ресурсов.',
        button: 'Создать',
      },
      creative: {
        title: 'Креативный',
        description:
          'Разделите ваш проект на главы, заметки и черновики. Рекомендуется для написания книг.',
        button: 'Создать',
      },
      annotations: {
        title: 'Заметки',
        description:
          'Используйте только функции для заметок. Рекомендуется для повседневных задач.',
        button: 'Создать',
      },
    },
    material: {
